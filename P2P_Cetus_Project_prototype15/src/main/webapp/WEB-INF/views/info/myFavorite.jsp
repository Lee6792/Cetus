...
<%@include file="../include/header.jsp" %>  
	...
	<div>	
			...
			<div style="float:right; margin-bottom: 1%">
				<input type="button"value ="삭제" class="remove">
			</div>
		<table class="custom-table">
			<tr>
				...
				<th style="width: 10%; text-align: center">캐시</th>
			...
			<c:forEach items="${Paginglist }" var = "lis" >
            	<tr>
            		<td>
            			<input type="checkbox" name="favorch" value="${lis.bno }" class="select_remove">
            		</td>
            		...
            		<td style="text-align: center">${lis.filesize }</td>
            		<td style="text-align: center">${lis.cash }</td>
            		<td style="text-align: center">${lis.id }</td>
            	</tr>
            </c:forEach>
		</table>
    </div>
