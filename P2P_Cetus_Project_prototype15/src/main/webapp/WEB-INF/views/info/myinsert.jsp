...
<form method = "post" id="thisForm" name = "myform">
     <div style="text-align: center; color :#4000FF; font-weight : bold">◎무료 회원 가입</div>
   <div style="text-align: center; color : #FE2EF7">Cetus는 회원님의 소중한 회원정보 보호를 위하여 Cetus 이용에 필요한 최소 정보만 입력 받습니다.</div>
     <hr class="hr1">
     <br>   
   <table id="table1">
   <tr>
   ...
   <tr>
      ...
      <label class = "a" id = "label_cpw">한번 더 입력하시오</label></td>
   </tr>
   <tr>
   ...
   <br>
      ...
      <input type="checkbox" name="age">만 14세이상입니다.<label style="color : red; font-weight : bold"> (필수)</label></div>
      ...
      <br>
      <div style="text-align: center">회원 가입을 원하시면 아래의 서비스 약관을 반드시 읽고 <label style="color : red; font-weight : bold">동의 버튼(필수)</label>을 선택해주세요.</div>
      <table>
      <tr>
         <td>
         <textarea rows="5" cols="48" style="resize: none">
<Cetus 이용약관>
제 1 조 [목적]
Cetus 이용약관은 ㈜선한아이디(이하 회사라 칭합니다)가 제공하는 인터넷서비스인 'www.filenori.com'(이하 총칭하여 서비스라 칭합니다)의 이용조건 및 절차, 서비스 이용에 필요한 제반사항에 대하여 규정함을 목적으로 합니다.
제 2 조 [약관의 효력과 변경]
...
② Cetus의 이용약관 등을 위반하여 이용 정지가 이루어진 회원 정보의 경우 부정 이용을 방지하기 위해 1년 동안 회원 정보를 보관합니다.
      ...
      <br>
      <div style="text-align: center"><input type="button" value="무료 회원가입" onclick="send(this.form)"></div>
</form>
</div>
 </aside>  
